                    ...
                    <div className={cx("footer-info")}>
                        <div className={cx("footer-info-item")}>
                            ...
                            <div className={cx("info-text")}>
                                ...
                                {t(
                                    "home.No. 28, Hang Voi Street, Ly Thai To Ward, Hoang Kiem District, Hanoi City, Vietnam"
                                )}
                            </div>
                        </div>
                        <div className={cx("footer-info-item")}>
                            ...
                            <div className={cx("info-text")}>
                                <span>{t("home.Phone")}:</span> 02439260315
                            </div>
                        </div>
                        <div className={cx("footer-info-item")}>
                            ...
                            <div className={cx("info-text")}>
                                <span>Email:</span> eev_group@eev.vn
                            </div>
                        </div>
                        <div className={cx("footer-info-item")}>
